Shader "NatureManufacture Shaders/Standard Shaders/Standard Specular Snow CutOut"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float4 lerpResult10 = lerp( lerpResult192 , ( triplanar162 * _SnowAlbedoColor ) , temp_output_113_0);
			...
			float4 lerpResult17 = lerp( ( tex2DNode29 * _SpecularPower ) , float4( ( appendResult151 * _SnowSpecularPower ) , 0.0 ) , temp_output_113_0);
			o.Specular = lerpResult17.rgb;
			float lerpResult28 = lerp( ( tex2DNode29.a * _SmoothnessPower ) , ( break150.w * _SnowSmoothnessPower ) , temp_output_113_0);
