Shader "NatureManufacture Shaders/Standard Shaders/Standard Specular Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float temp_output_220_0 = ( saturate( ( ( ( WorldNormalVector( i , lerpResult115 ).y * clampResult224 ) * ( ( clampResult224 * _SnowHardness ) * temp_output_106_0 ) ) * pow( triplanar175.y , _SnowHeightSharpness ) ) ) * 1.0 );
			...
			float4 lerpResult10 = lerp( lerpResult192 , ( triplanar162 * _SnowAlbedoColor ) , temp_output_220_0);
			o.Albedo = lerpResult10.xyz;
			float4 tex2DNode29 = tex2D( _SpecularRGBSmoothnesA, uv_MainTex );
			...
			float4 lerpResult17 = lerp( ( tex2DNode29 * _SpecularPower ) , float4( ( appendResult151 * _SnowSpecularPower ) , 0.0 ) , temp_output_220_0);
			o.Specular = lerpResult17.rgb;
			float lerpResult28 = lerp( ( tex2DNode29.a * _SmoothnessPower ) , ( break150.w * _SnowSmoothnessPower ) , temp_output_220_0);
