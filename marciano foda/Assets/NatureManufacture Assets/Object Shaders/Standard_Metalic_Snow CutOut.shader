 Shader "NatureManufacture Shaders/Standard Shaders/Standard Metalic Snow CutOut"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float lerpResult17 = lerp( ( tex2DNode2.r * _MetallicPower ) , ( break323.x * _SnowMetallicPower ) , temp_output_18_0);
			o.Metallic = lerpResult17;
			float lerpResult27 = lerp( ( tex2DNode2.a * _SmoothnessPower ) , ( break323.w * _SnowSmoothnessPower ) , temp_output_18_0);
