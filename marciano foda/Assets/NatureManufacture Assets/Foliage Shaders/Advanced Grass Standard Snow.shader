Shader "NatureManufacture Shaders/Grass/Advanced Grass Standard Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult483 = lerp( ( ( lerpResult433 * tex2DNode3 ) * half4( lerpResult465 , 0.0 ) ) , ( tex2D( _SnowCover, uv_SnowCover ) * _SnowColorBrightness ) , saturate( abs( ( ( newWorldNormal475.x + ( newWorldNormal475.y * _SnowMaxCover ) + newWorldNormal475.z ) * ( _Snow_Amount * clampResult505 ) ) ) ));
