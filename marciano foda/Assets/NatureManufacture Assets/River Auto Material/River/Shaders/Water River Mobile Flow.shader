 Shader "NatureManufacture Shaders/Water/Water River Mobile Flow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult1028 = (float2(_SlowWaterMixSpeed.y , _SlowWaterMixSpeed.x));
			...
			float2 panner1031 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _SlowWaterMixSpeed :  appendResult1028 ) + temp_output_1020_0);
			float2 WaterSpeedValueMix516 = panner1031;
			...
			float2 temp_output_934_0 = ( (lerpResult820).xy * float2( 0.05,0.05 ) );
			float2 appendResult1059 = (float2(_SmallCascadeMixSpeed.y , _SmallCascadeMixSpeed.x));
			float2 uv_TexCoord1045 = i.uv_texcoord * _SmallCascadeTiling;
			float2 temp_output_1049_0 = ( uv_TexCoord1045 * Globaltiling920 );
			float2 panner1062 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _SmallCascadeMixSpeed :  appendResult1059 ) + temp_output_1049_0);
			float2 SmallCascadeSpeedValueMix433 = panner1062;
			...
			float2 temp_output_963_0 = ( (lerpResult825).xy * float2( 0.1,0.1 ) );
			...
			float3 lerpResult330 = lerp( BlendNormals( BlendNormals( UnpackScaleNormal( tex2D( _WaterNormal, ( ( WaterSpeedValueMix516 * _MicroWaveTiling ) + temp_output_934_0 ) ), _MicroWaveNormalScale ) , UnpackScaleNormal( tex2D( _WaterNormal, ( WaterSpeedValueMix516 + temp_output_934_0 ) ), _MacroWaveNormalScale ) ) , lerpResult820 ) , BlendNormals( BlendNormals( UnpackScaleNormal( tex2D( _WaterNormal, ( ( SmallCascadeSpeedValueMix433 * _MicroWaveTiling ) + temp_output_963_0 ) ), _MicroWaveNormalScale ) , UnpackScaleNormal( tex2D( _WaterNormal, ( SmallCascadeSpeedValueMix433 + temp_output_963_0 ) ), _MacroWaveNormalScale ) ) , lerpResult825 ) , clampResult285);
			float2 appendResult1087 = (float2(_BigCascadeMixSpeed.y , _BigCascadeMixSpeed.x));
			float2 uv_TexCoord1079 = i.uv_texcoord * _BigCascadeTiling;
			float2 temp_output_1081_0 = ( uv_TexCoord1079 * Globaltiling920 );
			float2 panner1091 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _BigCascadeMixSpeed :  appendResult1087 ) + temp_output_1081_0);
			float2 BigCascadeSpeedValueMix608 = panner1091;
			...
			float2 temp_output_970_0 = ( (lerpResult830).xy * float2( 0.15,0.15 ) );
			float3 lerpResult529 = lerp( lerpResult330 , BlendNormals( BlendNormals( UnpackScaleNormal( tex2D( _WaterNormal, ( ( BigCascadeSpeedValueMix608 * _MicroWaveTiling ) + temp_output_970_0 ) ), _MicroWaveNormalScale ) , UnpackScaleNormal( tex2D( _WaterNormal, ( BigCascadeSpeedValueMix608 + temp_output_970_0 ) ), _MacroWaveNormalScale ) ) , lerpResult830 ) , clampResult514);
			...
			float3 temp_cast_19 = (lerpResult587).xxx;
			o.Specular = temp_cast_19;
