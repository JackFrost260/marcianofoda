Shader "NatureManufacture Shaders/Water/Water Swamp Vertex Color Flow Mobile"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 temp_output_1174_0 = ( (lerpResult838).xy * float2( 0.05,0.05 ) );
			float3 temp_output_1178_0 = BlendNormals( UnpackScaleNormal( tex2D( _WaterNormal, ( ( WaterSpeedValueMix516 * _MicroWaveTiling ) + temp_output_1174_0 ) ), _MicroWaveNormalScale ) , UnpackScaleNormal( tex2D( _WaterNormal, ( WaterSpeedValueMix516 + temp_output_1174_0 ) ), _MacroWaveNormalScale ) );
			float3 temp_output_24_0 = BlendNormals( temp_output_1178_0 , lerpResult838 );
			...
			float3 lerpResult983 = lerp( lerpResult750 , BlendNormals( temp_output_1178_0 , lerpResult1394 ) , WaterfallAng1120);
